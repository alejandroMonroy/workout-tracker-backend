"""
Seed runner: populates the database with initial exercise data.
...
async def seed_exercises() -> None:
    async with async_session() as session:
        ...
        print(f"✅ {len(new_exercises)} ejercicios insertados correctamente. Total en catálogo: {len(EXERCISES)}.")
