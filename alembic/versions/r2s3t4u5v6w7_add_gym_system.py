...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("plan_type", sa.Enum("monthly", "annual", "tickets", name="plantype"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("active", "frozen", "cancelled", "expired", "trial", name="membershipstatus"), nullable=False, server_default="active"),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("confirmed", "cancelled", "attended", "no_show", name="bookingstatus"), nullable=False, server_default="confirmed"),
